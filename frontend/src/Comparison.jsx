  ...
  return (
    <div className="comparison-section">
      ...
      <div className="overall-feedback">
        ...
        <p className="insight">
          💡 <strong>Agent Insight:</strong> The system recommends <strong>{feedback.best_channel}</strong> as the
          primary recovery channel for maximum opt-in and recovery rates.
        </p>
      </div>
    </div>
  );
